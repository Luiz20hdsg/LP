...
{fin = [(N 36),(N 72)], trans = 13},
{fin = [(N 50)], trans = 0},
{fin = [(N 41),(N 72)], trans = 15},
{fin = [(N 44)], trans = 0},
{fin = [(N 24),(N 72)], trans = 0},
{fin = [(N 22),(N 72)], trans = 18},
{fin = [(N 20)], trans = 0},
{fin = [(N 7),(N 72)], trans = 20},
{fin = [(N 7)], trans = 20},
{fin = [(N 34),(N 72)], trans = 0},
{fin = [(N 30),(N 72)], trans = 23},
{fin = [(N 47)], trans = 0},
...
| 12 => (PIPE(yypos, yypos))
| 14 => (NEGATIVE(yypos, yypos))
| 17 => (AND(yypos, yypos))
| 20 => (DOUBLECOLON(yypos, yypos))
| 22 => (COLON(yypos, yypos))
| 24 => (SEMICOLON(yypos, yypos))
| 26 => (COMMA(yypos, yypos))
| 28 => (PLUS(yypos, yypos))
| 30 => (MINUS(yypos, yypos))
| 32 => (MULTIPLIER(yypos, yypos))
| 34 => (DIVIDER(yypos, yypos))
| 36 => (EQUAL(yypos, yypos))
| 39 => (DIFFERENT(yypos, yypos))
| 4 => (lex())
| 41 => (LESS(yypos, yypos))
| 44 => (LESSEQUAL(yypos, yypos))
| 47 => (ARROW(yypos, yypos))
| 50 => (DOUBLEARROW(yypos, yypos))
| 52 => (OPENPARENTHESIS(yypos, yypos))
| 54 => (CLOSEPARENTHESIS(yypos, yypos))
| 56 => (OPENBRACKETS(yypos, yypos))
| 58 => (CLOSEBRACKETS(yypos, yypos))
| 60 => (OPENCBRACKETS(yypos, yypos))
| 62 => (CLOSECBRACKETS(yypos, yypos))
| 65 => (YYBEGIN COMMENTARY; lex())
| 68 => (YYBEGIN INITIAL; lex())
| 7 => let val yytext=yymktext() in CINT(toInt(yytext), yypos, yypos) end
| 70 => (lex())
| 72 => (error("Could not find character");
