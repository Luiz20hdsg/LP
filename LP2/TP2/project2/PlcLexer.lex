...
<INITIAL>"(" => (OPENPARENTHESIS(yypos, yypos));
<INITIAL>")" => (CLOSEPARENTHESIS(yypos, yypos));
<INITIAL>"[" => (OPENBRACKETS(yypos, yypos));
<INITIAL>"]" => (CLOSEBRACKETS(yypos, yypos));
<INITIAL>"{" => (OPENCBRACKETS(yypos, yypos));
<INITIAL>"}" => (CLOSECBRACKETS(yypos, yypos));
